...
```{r}
#Millorar-ho només incloent les variables mes importants (per exemple, any, mes, nom_partit, i potser d'altres segurament no calen) per l'informe, pots mostrar el resultat amb un kabble. Tampoc sé si fa falta calulcar tantes mètriques de cada variable. A mes, describe sembla que no tracta bé les categoriques. Cal descriure també els valors perduts, potser un summary seria millor. 
describe(dades)
```
