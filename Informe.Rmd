...
Tot i que els models lineals i mixtes aplicats als percentatges de vot no mostren un ajust perfecte, les funcions d’autocorrelació (ACF i PACF) i l’existència d’autocorrelació significativa—, els resultats obtinguts són coherent amb les tendències identificades per altres mètodes d’anàlisi.
