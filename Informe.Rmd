...
# Crear llista buida per guardar les taules
taules_list <- list()
...
for (partit in partits) {
  ...
  # Guardem la taula a la llista com a objecte LaTeX
  taules_list[[partit]] <- kable(
    df_tbl,
    format = "latex",
    booktabs = TRUE,
...
# Ara imprimim totes les taules **seguides**
for (t in taules_list) {
  cat(t, "\n\n")  # "\n\n" per separar taules
}
```
