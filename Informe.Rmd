...
Els gràfics de qualitat de representació ($cos^2$) i de contribució a les dimensions principals es troben a la secció \nameref{sec:grafics_compl_ca}. A partir d’aquí, es dona per suposat que qualsevol referència a aquests aspectes visuals remet a aquesta secció.
...
```{r ca2015, fig.cap="CA de les eleccions del desembre del 2015.", fig.width=12, fig.height=5, fig.align='center', fig.pos='H',fig.show='hold'}

plots_ca$`Desembre 2015`$biplot + plots_ca$`Desembre 2015`$rows_cos2
```
...
```{r, fig.cap="Contribució de partits i variables pel CA de les eleccions del desembre del 2015.", fig.width=12, fig.height=5, fig.align='center', fig.pos='H',fig.show='hold'}

plots_ca$`Desembre 2015`$rows_contrib+ plots_ca$`Desembre 2015`$cols_contrib
```
...
```{r, fig.cap="Qualitat de representació de partits i variables pel CA de les eleccions del desembre del 2015.", fig.width=12, fig.height=5, fig.align='center', fig.pos='H',fig.show='hold'}

plots_ca$`Desembre 2015`$rows_cos2+ plots_ca$`Desembre 2015`$cols_cos2
```
...
```{r ca2016, fig.cap="CA de les eleccions de juny del 2016.", fig.width=12, fig.height=5, fig.align='center', fig.pos='H',fig.show='hold'}

plots_ca$`Juny 2016`$biplot + plots_ca$`Juny 2016`$rows_cos2
```
...
```{r, fig.cap="Contribució de partits i variables pel CA de les eleccions del juny del 2016.", fig.width=12, fig.height=5, fig.align='center', fig.pos='H',fig.show='hold'}

plots_ca$`Juny 2016`$rows_contrib+ plots_ca$`Juny 2016`$cols_contrib
```
...
```{r, fig.cap="Qualitat de representació de partits i variables pel CA de les eleccions del juny del 2016.", fig.width=12, fig.height=5, fig.align='center', fig.pos='H',fig.show='hold'}

plots_ca$`Juny 2016`$rows_cos2+ plots_ca$`Juny 2016`$cols_cos2
```
...
```{r ca2019a, fig.cap="CA de les eleccions de l'abril del 2019.", fig.width=12, fig.height=5, fig.align='center', fig.pos='H',fig.show='hold'}

plots_ca$`Abril 2019`$biplot + plots_ca$`Abril 2019`$rows_cos2
```
...
```{r, fig.cap="Contribució de partits i variables pel CA de les eleccions del abril del 2019", fig.width=12, fig.height=5, fig.align='center', fig.pos='H',fig.show='hold'}

plots_ca$`Abril 2019`$rows_contrib+ plots_ca$`Abril 2019`$cols_contrib
```
...
```{r, fig.cap="Qualitat de representació de partits i variables pel CA de les eleccions de l'abril del 2019", fig.width=12, fig.height=5, fig.align='center', fig.pos='H',fig.show='hold'}

plots_ca$`Abril 2019`$rows_cos2+ plots_ca$`Abril 2019`$cols_cos2
```
...
```{r ca2019n, fig.cap="CA de les eleccions del novembre del 2019.", fig.width=12, fig.height=5, fig.align='center', fig.pos='H',fig.show='hold'}

plots_ca$`Novembre 2019`$biplot + plots_ca$`Novembre 2019`$rows_cos2
```
...
```{r, fig.cap="Contribució de partits i variables pel CA de les eleccions del novembre del 2019.", fig.width=12, fig.height=5, fig.align='center', fig.pos='H',fig.show='hold'}

plots_ca$`Novembre 2019`$rows_contrib+ plots_ca$`Novembre 2019`$cols_contrib
```
...
```{r, fig.cap="Qualitat de representació de partits i variables pel CA de les eleccions del novembre del 2019.", fig.width=12, fig.height=5, fig.align='center', fig.pos='H',fig.show='hold'}

plots_ca$`Novembre 2019`$rows_cos2+ plots_ca$`Novembre 2019`$cols_cos2
```
...
```{r ca2023, fig.cap="CA de les eleccions de juliol del 2023.", fig.width=12, fig.height=5, fig.align='center', fig.pos='H',fig.show='hold'}

plots_ca$`Juliol 2023`$biplot + plots_ca$`Juliol 2023`$rows_cos2
```
...
```{r, fig.cap="Contribució de partits i variables pel CA de les eleccions del juliol del 2023.", fig.width=12, fig.height=5, fig.align='center', fig.pos='H',fig.show='hold'}

plots_ca$`Juliol 2023`$rows_contrib+ plots_ca$`Juliol 2023`$cols_contrib
```
...
```{r, fig.cap="Qualitat de representació de partits i variables pel CA de les eleccions del juliol del 2023.", fig.width=12, fig.height=5, fig.align='center', fig.pos='H',fig.show='hold'}

plots_ca$`Juliol 2023`$rows_cos2+ plots_ca$`Juliol 2023`$cols_cos2
```
