...
Punts de tall triats a partir de llindars habituals en estudis de desigualtat (Falta citar link https://www.numberanalytics.com/blog/complete-guide-wealth-gini-coefficient-index?utm)
...
```{r}
dades$Porcentaje_poblacion_no_española<- 100-dades$`Porcentaje de población española`

summary(dades$Porcentaje_poblacion_no_española)
