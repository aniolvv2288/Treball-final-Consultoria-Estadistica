...
cuts_mediana_uc
```
#### Distribució de la renda (P80/P20)

```{r}
#### Distribució de la renda (P80/P20)

summary(dades$`Distribución de la renta P80/P20`)

hist(
  dades$`Distribución de la renta P80/P20`,
  main = "Distribució de la renda (P80/P20)",
  xlab = "Ràtio P80/P20",
  breaks = 30
)
